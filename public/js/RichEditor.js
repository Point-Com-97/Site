...
function createEmbed(src, platform) {
    ...
    return wrapMediaElement(iframe, platform);
}
...
function createDirectVideo(url) {
    ...
    return wrapMediaElement(video, 'direct');
}

// ⭐ RENOMMÉE : wrapMedia → wrapMediaElement pour éviter les conflits
function wrapMediaElement(element, platform) {
    const container = document.createElement('div');
